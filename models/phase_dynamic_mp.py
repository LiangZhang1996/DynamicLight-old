"""
DynamicLight that use Efficient-MP to determine the phase
...
class DynamicAgentMP(NetworkAgent):
    ...
    def phase_control_policy(self, feat0):
        if self.num_lane == 8:
            ...
            feat10 = (feat0[1] + feat0[2] + feat0[5] + feat0[6])/2
            feat20 = (feat0[9] + feat0[10] + feat0[13] + feat0[14])/2
